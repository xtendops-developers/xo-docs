...
<div align="center">
  ![REST API Call Step](/steps/images/rest-step.png)
</div>
...
[Learn more about the Secrets Manager →](/platform/settings#integrations)
...
**Tip:** Use a [JavaScript Code step](/steps/javascript-code) after the REST API Call to parse and extract specific information from the response.
...
- [JavaScript Code](/steps/javascript-code) - Transform API responses
- [Structured Output](/steps/structured-output) - Format API request data
- [Router](/steps/router) - Handle different response scenarios
