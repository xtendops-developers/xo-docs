...
<div align="center">
  ![JavaScript Code Step](/steps/images/js-step.png)
</div>
...
Use conditional logic to determine the next step for the [Router step](/steps/router).
...
- [Structured Output](/steps/structured-output) - Transform data into defined formats
- [Router](/steps/router) - Route based on calculated values
