...
<img
  src="/smartAgentApp/images/copilot-app-interface.png"
  alt="Co-Pilot App Interface"
/>
...
Allows agents to trigger specific SmartActions via typed commands.
...
Triggers a SmartAction to rephrase the response in a friendlier tone with emojis.
...
- `/[custom-action]` - Any configured SmartAction

[Learn more about SmartActions →](/platform/smartAgentActions)

### SmartActions Access

Agents can directly trigger configured SmartActions from the app, including timer-based responses.
