...
This variable is often the output of a [Structured Output step](/platform/steps/structured-output) or [JavaScript Code step](/platform/steps/javascript-code) that determines the routing logic.
