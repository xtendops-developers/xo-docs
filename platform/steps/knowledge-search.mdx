...
The **Knowledge Search** step retrieves relevant articles from your knowledge base using semantic similarity search.
...
<div align="center">
  ![Knowledge Search Step](/images/steps/knowledge-step.png)
</div>
...
- [Structured Output](/platform/steps/structured-output) - Extract structured data from knowledge
