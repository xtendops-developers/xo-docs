...
Select the LLM provider for generating responses.
...
LLM provider used for compressing conversation history into signatures.

**Recommended:** Gemini (cost-effective for compression tasks)

### Compression LLM Model

Specific model used for compression.
...
LLM provider for automatic prompt improvement.

**Recommended:** Anthropic (Claude)

### Auto-Prompt LLM Model

Specific model for prompt improvement.
