...
**Use case:** Output the `next_step` value to a variable that the [Router step](/platform/steps/router) uses to determine workflow path. The conversation flows from greeting → issue identification → issue resolution → closing.
